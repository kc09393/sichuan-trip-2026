const itineraries = [
  ...
  { date:"9/8", weekday:"二", title:"青城山＋都江堰夜遊", city:"青城山・都江堰", lodging:"成都", tone:"hard", note:"產品 24789045 套票 B 已確認：3 位成人共 TWD 2,937，含兩景區門票與人工精講、川劇短演出、灌縣古城及藍眼淚夜景。07:00 為集合基準，成都三環內飯店免費上門接；實際接人可能提前約 1 小時，以前一晚通知為準。", items:[
    ["前一晚 20:00 後","確認接車通知","供應商會確認飯店地址與實際接人時間；若 22:00 前仍沒收到通知，主動從 Trip.com 訂單聯絡客服。","成都住宿區"],
    ["約 06:00 起・通知為準","成都三環內飯店免費接人","訂單集合基準為 07:00，飯店接人可能提前約 1 小時。不用退房、不帶大件行李；三人帶訂票使用的有效證件原件、水、零食與防滑鞋。","成都住宿區"],
    ...
    ["約 22:00–22:30","返回成都","實際下車位置與時間受交通及當日團務影響，以導遊通知為準；抵達後直接休息，隔天不排早起行程。","成都住宿區"]
  ]},
...
const dayGuides = [
  ...
  {effort:"高強度・約 15 小時",summary:"成都飯店接人 → 青城山前山 → 川劇短演出 → 都江堰精講 → 藍眼淚／古城夜景 → 返回成都。",facts:[
    ["badge-check","套票 B 已確認","產品 ID 24789045；3 位成人共 TWD 2,937，含青城山、都江堰門票、兩景區中文導遊講解、川劇短演出、灌縣古城及藍眼淚夜景。"],
