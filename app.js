const itineraries = [
  ...
  { date:"9/10", weekday:"四", title:"成都經典文化完整版", city:"成都", lodging:"璽悅·瀾庭度假公寓", tone:"hard", note:"把尚未走過的成都經典一次完成：文殊院、杜甫草堂、人民公園、武侯祠、錦里，晚上再看安順廊橋。明天約 18–25°C、多雲，清晨及深夜可能有雨，帶摺疊傘。", items:[
    ["07:30","起床・早餐後出發","今天景點較滿，早餐不要排熱門店；帶三人的台胞證原件、行動電源、水和摺疊傘。","璽悅·瀾庭度假公寓"],
    ["08:00–09:00","文殊院・文殊坊","先補上今天因三星堆未去的文殊院；走寺院中軸與文殊坊即可，免門票，09:00 準時離開。","文殊院"],
    ["09:00–09:30","叫車前往杜甫草堂","直接叫車跨到成都西側，避免為了省一點車費轉乘繞路。","杜甫草堂"],
    ["09:30–11:30","杜甫草堂","走大廨、詩史堂、柴門、工部祠、茅屋與紅牆花徑主線；官方 09:00–18:00 開放、17:00 停止售票。","杜甫草堂"],
    ["11:50–13:20","人民公園・午餐與蓋碗茶","先在公園周邊吃正餐，再到鶴鳴茶社坐約 30–40 分鐘；這段同時補充體力，不再繞去已逛過的寬窄巷子。","人民公園"],
    ["13:20–13:50","叫車前往武侯祠","確認門票與證件都在身上；最晚 14:00 左右入館，遠早於 17:00 停止入館。","武侯祠・錦里"],
    ["14:00–16:30","武侯祠","依漢昭烈廟、武侯祠、三義廟與惠陵主線參觀；官方 09:00–18:00 開放、17:00 停止入館。","武侯祠・錦里"],
    ["16:30–18:30","錦里・晚餐","從武侯祠直接步行進錦里，拍黃昏街景並吃晚餐；不再安排川劇，爸媽今晚已經看過。","武侯祠・錦里"],
    ["19:00–20:30","安順廊橋・九眼橋夜景","叫車到安順廊橋，在錦江沿岸散步拍夜景；不買遊船也能看燈景，約 20:30 叫車回公寓。","安順廊橋"],
...
const dayGuides = [
  ...
  ],spot:["今天的實際安排","原定文殊院改由三星堆取代；文殊院移到 9/10 早上，春熙路與川劇則保留在今晚。"]},
  {effort:"高強度・完整成都日",summary:"文殊院 → 杜甫草堂 → 人民公園午餐喝茶 → 武侯祠／錦里 → 安順廊橋夜景。",facts:[
    ["route","完整但路線不回頭","先從飯店北側文殊院開始，再叫車往西到杜甫草堂，之後向東南依序走人民公園與武侯祠，最後才跨到錦江夜景。"],
    ...
    ["clock-3","兩館時間已留足","杜甫草堂與武侯祠目前皆為 09:00–18:00、17:00 停止售票／入館；排 09:30 與 14:00 入館，不壓閉館線。"],
    ["route-off","不再排川劇與重複景點","爸媽 9/9 晚上已安排川劇；天府廣場、寬窄巷子與春熙路也都走過，明天全部不重複。"],
    ["utensils","兩次坐下休息","人民公園把午餐與蓋碗茶合在一起，錦里再吃晚餐；爸媽中午與傍晚都有完整坐下時間。"],
    ["luggage","21:00 回房整理","夜景後直接叫車回公寓，完成全員行李、確認隔天前往 TFU T1 的六座車，並處理你的成渝高鐵。"]
  ],spot:["為什麼不再加成都博物館","三星堆後隔天連看三座博物館容易疲勞；這版用文殊院與安順廊橋補足早晚，把杜甫草堂、武侯祠兩個核心館看完整。"]},
...
const dayFallbacks=[
  ...
  "若下雨或落後超過 1 小時，先把人民公園縮為 30 分鐘；16:00 後才進武侯祠就取消安順廊橋。核心順序只保留文殊院、杜甫草堂與武侯祠／錦里。",
...
const mapPlaces = [
  ...
  {name:"文殊院",area:"青羊區",desc:"9/10 早上補走的第一站；沿寺院中軸與文殊坊簡單參觀，09:00 準時離開前往杜甫草堂。",lat:30.6804,lng:104.0747,type:"sight",days:[6],stay:"08:00–09:00",icon:"landmark"},
  {name:"杜甫草堂",area:"青羊區・青華路 37 號",desc:"9/10 走茅屋、詩史堂、工部祠與紅牆花徑主線；官方 09:00–18:00 開放、17:00 停止售票。",lat:30.6607,lng:104.0282,type:"sight",days:[6],stay:"09:30–11:30",icon:"book-open"},
  {name:"人民公園",area:"青羊區・祠堂街",desc:"9/10 在周邊吃午餐並到鶴鳴茶社喝蓋碗茶；若下雨或落後可縮為 30 分鐘。",lat:30.6579,lng:104.0559,type:"sight",days:[6],stay:"11:50–13:20・可縮短",icon:"coffee"},
  {name:"武侯祠・錦里",area:"武侯區",desc:"9/10 14:00 進武侯祠，之後直接步行到隔壁錦里看黃昏街景與吃晚餐。",lat:30.6453,lng:104.0487,type:"sight",days:[6],stay:"14:00–18:30",icon:"landmark"},
  {name:"安順廊橋",area:"錦江區・合江亭旁",desc:"9/10 成都完整日最後一站；沿錦江步行看廊橋與九眼橋夜景，不搭船也能拍照。",lat:30.6419,lng:104.0832,type:"sight",days:[6],stay:"19:00–20:30・下雨可取消",icon:"bridge"}
];
