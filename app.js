const itineraries = [
  ...
  { date:"9/10", weekday:"四", title:"杜甫草堂・武侯祠完整日", city:"成都", lodging:"璽悅·瀾庭度假公寓", tone:"hard", record:"今日紀錄（進行中）：10:00 才從公寓出發，文殊院依本人意願取消；保留杜甫草堂、人民公園、武侯祠、錦里與安順廊橋。", items:[
    ...
    ["12:30–13:30","杜甫草堂周邊午餐","先吃正餐、補水並坐下休息；不要排需要久候的熱門店，13:30 左右叫車離開。","杜甫草堂"],
    ["約 13:50–14:40","人民公園・鶴鳴茶社","到公園散步並喝一杯蓋碗茶，停留約 40–50 分鐘；寬窄巷子已經去過，不再繞回。","人民公園"],
    ["14:40–15:10","叫車前往武侯祠","確認門票與證件都在身上；目標 15:10 入館，最晚不要超過 16:00。","武侯祠・錦里"],
    ["15:10–16:50","武侯祠","依漢昭烈廟、武侯祠、三義廟與惠陵主線參觀；官方 17:00 停止入館，進館後不要在入口區停留太久。","武侯祠・錦里"],
    ["16:50–18:40","錦里・晚餐","從武侯祠直接步行進錦里，拍黃昏街景並吃晚餐；爸媽昨晚已看川劇，今天不再重複。","武侯祠・錦里"],
    ["19:10–20:30","安順廊橋・九眼橋夜景","叫車到安順廊橋，在錦江沿岸散步拍夜景；不買遊船也能看燈景，約 20:30 叫車回公寓。","安順廊橋"],
...
const dayGuides = [
  ...
  {effort:"中高強度・10:00 起步",summary:"杜甫草堂 → 午餐 → 人民公園喝茶 → 武侯祠／錦里 → 安順廊橋夜景。",facts:[
    ["route","文殊院已取消","10:00 才出發就不再繞往北側；直接叫車到杜甫草堂，再向東南走人民公園與武侯祠，路線更乾淨。"],
    ...
    ["clock-3","武侯祠是唯一硬時限","杜甫草堂與武侯祠目前皆為 09:00–18:00、17:00 停止售票／入館；今天目標 15:10 進武侯祠，最晚不要超過 16:00。"],
  ...
  ],spot:["10:00 出發還玩得完嗎","可以。取消文殊院後，兩個付費核心館各留約 1.5–2 小時，人民公園負責午間休息，錦里接晚餐；只要 16:00 前進武侯祠，整條線仍走得完。"]},
...
const dayFallbacks=[
  ...
  "若 13:30 還沒離開杜甫草堂，就把人民公園縮為 20–30 分鐘；若 16:00 才進武侯祠，晚上取消安順廊橋。核心只保留杜甫草堂、武侯祠與錦里。",
...
const mapPlaces = [
  ...
  {name:"人民公園",area:"青羊區・祠堂街",desc:"9/10 午餐後到鶴鳴茶社喝蓋碗茶；若杜甫草堂離開較晚，可縮為 20–30 分鐘。",lat:30.6579,lng:104.0559,type:"sight",days:[6],stay:"13:50–14:40・可縮短",icon:"coffee"},
  {name:"武侯祠・錦里",area:"武侯區",desc:"9/10 目標 15:10 進武侯祠，之後直接步行到隔壁錦里看黃昏街景與吃晚餐。",lat:30.6453,lng:104.0487,type:"sight",days:[6],stay:"15:10–18:40",icon:"landmark"},
  {name:"安順廊橋",area:"錦江區・合江亭旁",desc:"9/10 成都完整日最後一站；沿錦江步行看廊橋與九眼橋夜景，不搭船也能拍照。",lat:30.6419,lng:104.0832,type:"sight",days:[6],stay:"19:10–20:30・下雨可取消",icon:"bridge"}
];
