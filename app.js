const itineraries = [
  ...
  { date:"9/7", weekday:"一", title:"九寨溝 → 成都・輕鬆夜遊", city:"提早回程", lodging:"璽悅·瀾庭度假公寓", tone:"move", note:"15:14 抵達成都東後先叫車入住。若準時入住、雨勢不大且大家有精神，傍晚只去一站外的天府廣場吃飯看夜景；最晚 20:00 回公寓確認明早接車，任何延誤或疲累就直接取消。", items:[
    ...
    ["17:30–18:30","天府廣場附近晚餐","從騾馬市搭地鐵 1 號線一站，或直接叫車；先吃正餐，不排需要久候或太辣的餐廳。","天府廣場"],
    ["18:30–19:30","天府廣場夜景・短程散步","只在廣場周邊看夜景拍照，不再延伸到春熙路；若下雨或爸媽累了就立刻回公寓。","天府廣場"],
    ["20:00 前","回公寓・確認明日接車","20:00 後留意供應商通知；若 22:00 前仍沒收到 9/8 接車時間，從 Trip.com 訂單主動聯絡。","璽悅·瀾庭度假公寓"]
  ]},
...
const dayFallbacks=[
  ...
  "若 C5794 延誤、入住晚於 17:30、下雨或任何人疲累，就取消天府廣場，直接在公寓附近吃飯或叫外送；20:00 後確認 9/8 接車時間仍是唯一優先。",
...
const mapPlaces = [
  ...
  {name:"天府廣場",area:"青羊區・成都中心",desc:"9/7 入住休息後的唯一彈性加碼；從騾馬市搭地鐵 1 號線一站，先吃晚餐再看夜景，最晚 20:00 回公寓。",lat:30.6573,lng:104.0658,type:"sight",days:[3],stay:"9/7 17:30–19:30・免門票",icon:"sparkles"},
