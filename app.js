const itineraries = [
  ...
  { date:"9/10", weekday:"四", title:"杜甫草堂・武侯祠與錦里", city:"成都", lodging:"璽悅·瀾庭度假公寓", tone:"city", note:"寬窄巷子已在 9/7 晚上完成，今天不走回頭路。保留杜甫草堂、人民公園與武侯祠／錦里；若下雨就縮短戶外段，完整川劇仍只當可選加碼。", items:[
    ["08:30","飯店出發前往杜甫草堂","帶三人的購票證件原件；官方 9 月常規 09:00 開館，目標開門後入館。","杜甫草堂"],
    ["09:00–11:00","杜甫草堂","走大廨、詩史堂、柴門、工部祠、茅屋與紅牆花徑主線；不用把整個園區走滿。","杜甫草堂"],
    ["11:20–12:30","杜甫草堂附近午餐","先吃正餐、補水並坐下休息；不趕熱門排隊店，雨勢大時可直接叫車前往下一站。","杜甫草堂"],
    ["12:50–14:10","人民公園・鶴鳴茶社","喝蓋碗茶、坐著休息；寬窄巷子已去過，不再繞回。若下雨明顯，可縮短或直接取消這段。","人民公園"],
    ["14:40–16:40","武侯祠","官方目前 09:00–18:00 開放、17:00 停止入館；下午看漢昭烈廟、武侯祠與三義廟。","武侯祠・錦里"],
    ["16:40–18:40","錦里・提早吃晚餐","武侯祠旁直接步行進錦里；若已訂劇場，18:40 前叫車離開。","武侯祠・錦里"],
...
const dayGuides = [
  ...
  {effort:"中低・晚起慢遊",summary:"睡飽 → 文殊院／文殊坊 → 午餐與短休 → 春熙路／太古里／IFS → 早回飯店。",facts:[
    ...
    ["route-off","不增加三星堆","三星堆需要再安排一個完整往返日，會擠壓成都恢復日與市區文化線；除非三人特別喜歡考古，這趟不臨時加。"]
  ],spot:["文殊院＋春熙路為什麼同一天","兩處都在成都核心區，從飯店出發移動簡單；上午睡飽後仍能完成，而且沒有必須趕上的城際交通。"]},
  {effort:"中等・雨天可縮",summary:"杜甫草堂 → 人民公園喝茶 → 武侯祠／錦里 → 可選錦江劇場；寬窄巷子已完成，不再重複。",facts:[
    ["route","刪除重複景點後更順","先由西側杜甫草堂開始，再到人民公園坐下喝茶，下午向南到武侯祠／錦里；不再繞去 9/7 已走過的寬窄巷子。"],
    ["ticket-check","兩館長者可換免費票","杜甫草堂與武侯祠全票各 ¥50；60 歲以上港澳台長者持台胞證原件可換免費票，另外兩位成人再購全票。"],
    ["cloud-rain","9/10 有雨就少走戶外","9/7 查詢的預報顯示 9/10 可能有雨；人民公園可縮短或取消。想改室內行程時，成都博物館需先從官方管道確認預約名額。"],
    ["clock-3","控制每段時間","杜甫草堂 2 小時、人民公園約 1 小時、武侯祠 2 小時；武侯祠最晚 17:00 前入館。"],
    ["clock-3","完整劇場版是加碼","9/8 已看川劇短演出；只有仍想看約 70 分鐘完整版本才買票。買票後才需 18:30 前吃完晚餐、19:20 抵達取票。"],
    ["utensils","吃飯安排","杜甫草堂附近簡單午餐，晚餐提早在錦里解決；不要排需要久候的餐廳。"],
    ["luggage","看完直接回飯店","演出結束後直接叫車回飯店，完成全員行李、預約隔天前往 TFU T1 的六座車，並確認你的成渝高鐵。"]
  ],spot:["成都文化線看什麼","杜甫草堂看唐詩與園林，人民公園體驗蓋碗茶，武侯祠理解蜀漢歷史，錦里主要留給晚餐。今天不需要為了填空檔再加景點。"]},
...
const dayFallbacks=[
  ...
  "若下雨或落後超過 1 小時，縮短或刪除人民公園；寬窄巷子已完成、不再安排。武侯祠要在 17:00 前入館，演出票買好後才以 19:20 抵達錦江劇場為底線。",
...
const mapPlaces = [
  ...
  {name:"人民公園",area:"青羊區・祠堂街",desc:"9/10 於鶴鳴茶社喝蓋碗茶並坐下休息；若下雨或疲累可縮短或取消。",lat:30.6579,lng:104.0559,type:"sight",days:[6],stay:"12:50–14:10・雨天可刪",icon:"coffee"},
