const itineraries = [
  ...
  { date:"9/7", weekday:"一", title:"九寨溝 → 成都", city:"提早回程", lodging:"成都", tone:"move", note:"今天不排景點。07:20 搭共乘車到黃龍九寨站，銜接已購買的 C5794，15:14 抵達成都東。", items:[
    ["06:30","起床、早餐、退房","確認證件、動車票與接駁憑證；約 07:00 到飯店通知的集合點等車。","九寨溝住宿區"],
    ["07:20–約 10:20","共乘車：九寨溝 → 黃龍九寨站","預訂 9/7 的 07:20 班次並填寫飯店名稱；平台預估 10:20 抵達，實際集合點以前一日通知為準。","黃龍九寨站"],
    ["10:20–12:35","車站等候・吃東西","保留 2 小時 48 分鐘公路與進站緩衝；抵達後吃東西、上洗手間，12:35 前完成安檢。","黃龍九寨站"],
...
const dayGuides = [
  ...
  {effort:"早起・輕鬆移動",summary:"07:20 共乘車 → 黃龍九寨站 → C5794 → 成都飯店。今天沒有景點，15:14 就回到成都東。",facts:[
    ["bus-front","接駁班次","選 9/7 的 07:20 九寨溝 → 黃龍九寨站共乘車；預訂時填飯店名稱，約 07:00 到通知的集合點。"],
    ["clock-3","安全緩衝","平台預估 10:20 抵達，C5794 於 13:08 發車，保留 2 小時 48 分鐘處理交通浮動與安檢。"],
...
const dayFallbacks=[
  ...
  "出發前一日確認 07:20 接駁與集合點；若供應商預估無法在 11:30 前抵站，立即聯絡調整，安全銜接 C5794 是唯一優先。",
